...
Execution mode: `ai-assisted`.

Use this mode when the AI performs substantial work, but a human is expected to steer implementation details during execution.

Milestone scope should be medium. Focus areas should be coherent but leave explicit checkpoints where human input may be needed.

Do not create overly broad autonomous implementation scope.
