...
Do not include implementation source files, test files, generated code, workflow YAML, broad unrelated documentation cleanup, TBPs, issue templates, copied guide documents, or pre-authored `.execution/` ledgers.
