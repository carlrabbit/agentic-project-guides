...
Execution mode: `engineering-migration`. Use for command contracts, build/test infrastructure, repository layout, validation tiers, CI behavior, package/release substrate, or guide-system migrations.
